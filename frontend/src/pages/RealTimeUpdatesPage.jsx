...
export default function RealTimeUpdatesPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Real Time Campaign Progress</h1>
        <p className="text-gray-600 mt-1">Monitor campaign sending, delivery, open, and click metrics in real time</p>
      </div>
              ...
              <Grid item xs={12} md={6} lg={4} key={c._id}>
                <Paper sx={{ bgcolor: '#23242b', borderRadius: 3, p: 3, boxShadow: '0 2px 8px 0 rgba(0,0,0,0.10)', height: '100%' }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
                    ...
                    <Chip
                      label={prog.status ? prog.status.charAt(0).toUpperCase() + prog.status.slice(1) : ''}
